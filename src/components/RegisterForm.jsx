...
const RegisterForm = () => {
  ...
  return (
    <div className="items-center justify-center py-8 bg-indigo-50">
      <p className="py-4 text-2xl font-bold text-center text-indigo-600">
        Please Register or Login to start managing Shows
      </p>
